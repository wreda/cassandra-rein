...
public class DatabaseDescriptor
{
    ...
    public static boolean getReinEnabled()
    {
        return conf.rein_enabled;
    }

    public static void setReinEnabled(boolean rein_enabled)
    {
        conf.rein_enabled = rein_enabled;
    }
    ...
    public static List<Integer> getQueueWeights() { return conf.queue_weights; }
    ...
    public static int getSDSThreshold() { return conf.sds_threshold; }

    public static void setSDSThreshold(int sds_threshold) { conf.sds_threshold = sds_threshold; }
