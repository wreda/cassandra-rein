...
public class Config
{
    ...
    public boolean rein_enabled =true;

    public String priority_strategy="hybrid";

    public String queue_type="multiqueue";

    public List<Integer> queue_weights = Arrays.asList(5, 4, 3, 2, 1);

    //public List<Integer> queue_weights = Arrays.asList(1, 3, 6, 8, 10);

    public int initial_queue_range = 5;

    public int queue_range_factor = 5;

    public int sds_threshold = 20;
