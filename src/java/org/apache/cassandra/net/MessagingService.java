...
public final class MessagingService implements MessagingServiceMBean
{
    ...
    {{
        ...
        put(Verb.READMULTI, ReadMultiCommand.serializer);
    ...
    {{
        ...
        put(Verb.READMULTI, ReadMultiResponse.serializer);
    ...
    {
        tracker.updateLocalMetrics(serviceTime, opSize, priority);
    }

    public double getExpectedResponseTime(Pair<InetAddress, Double> key, int opSize)
    {
        return tracker.getExpectedResponseTime(key, opSize);
    }
